#!/usr/bin/env python3
"""Build Stage 4 Deep-Sea Canyon sea and connected parallax strips."""
...
RUN_DIR = ROOT / "assets" / "generated" / "backgrounds" / "stage4-deep-canyon"
...
SEA_PALETTE = [
    (20, 57, 118), (15, 47, 105), (12, 39, 91), (10, 32, 78),
    (8, 26, 65), (7, 21, 55), (6, 17, 46), (5, 14, 39),
    (4, 11, 32), (3, 8, 25),
]
TERRAIN_PALETTE = [
    (3, 8, 22), (4, 13, 34), (5, 20, 49), (7, 29, 65),
    (9, 39, 82), (12, 51, 99), (17, 64, 117), (24, 78, 135),
    (35, 94, 151), (51, 112, 166), (72, 132, 180),
    (49, 48, 105), (68, 58, 125), (88, 72, 143),
    (110, 91, 160), (138, 116, 178), (158, 148, 196),
]
LAYERS = {
    "far": {"height": 80, "parallax": 0.10, "source": "far-long-source-v1.png", "cap_width": 42, "cap_height": 14},
    "mid": {"height": 80, "parallax": 0.30, "source": "mid-long-source-v2.png", "cap_width": 58, "cap_height": 24},
    "near": {"height": 128, "parallax": 0.78, "source": "near-long-source-v1.png", "cap_width": 84, "cap_height": 44},
}
...
def load_subject(path: Path) -> Image.Image:
    """Load generated terrain, remove transparent/checker backing, and force binary alpha."""
    ...
    for y in range(source.height):
        for x in range(source.width):
            ...
            if has_transparency:
                ...
                # ImageGen sometimes renders its transparency checker into RGB.
                continue
            dst[x, y] = (r, g, b, 255)
    return output
...
def main() -> None:
    ...
    manifest = {
        "version": 1, "kind": "pixel-wave-stage-background", "stage": "stage4",
        "name": "심해 협곡", "logical_viewport": [480, 270],
        "palette": [list(color) for color in TERRAIN_PALETTE], "layers": layers,
        "runtime_effects": ["faint-cold-shafts", "sparse-abyss-motes", "gameplay-darkness-mask"],
        "prompt_log": "generation-prompts.md",
        "notes": "Connected cold abyss canyon layers stay low through the playfield while one native-scale foreground shelf supplies the Stage 4 landmark.",
    }
    (RUN_DIR / "manifest.json").write_text(
        json.dumps(manifest, ensure_ascii=False, indent=2) + "\n", encoding="utf-8"
    )
    print("built Stage 4 sea + far/mid/near strips")
