#!/usr/bin/env python3
"""Build deterministic 480x270 ending-screen background candidates."""
...
SOURCE = RUN_DIR / "source" / "ending-concept-v1.png"
...
def main() -> None:
        ...
        json.dumps(
            {
                ...
                "game_input": "../../../screens/ending-background.png",
            },
            ensure_ascii=False,
            indent=2,
        ) + "\n",
    ...
    print(f"built {len(outputs)} ending candidates at {TARGET_SIZE[0]}x{TARGET_SIZE[1]}")
