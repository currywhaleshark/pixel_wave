...
class Stage3SpritePipelineTest(unittest.TestCase):
    ...
    def test_turtle_taxi_and_ssing_are_normalized_and_packed(self) -> None:
        self.assert_packed_run("turtle-taxi", "paddle", "sprites.png", (0, 128), (32, 20))
        self.assert_packed_run("ssing", "flap", "bosses.png", (0, 64), (56, 40))
